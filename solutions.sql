...
from film_actor a1 # join first table of film_actor and actor
join actor a3
on a1.actor_id = a3.actor_id # join film_id and film title
join film f
on a1.film_id = f.film_id # self join
join film_actor a2
on a1.actor_id <> a2.actor_id
and a1.film_id = a2.film_id # join second table of film_actor and actor
join actor a4
